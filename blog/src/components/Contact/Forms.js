...
function Forms() {
    ...
    const submitForm = (e) => {
        ...
        const suject = e.target.suject.value;
        const message = e.target.message.value;
        // const contact_img = e.target.contact_img.files[0];
        console.warn([f_name, l_name, email]);

        axios.post("http://localhost:8081/contactus", {
            f_name,
            l_name,
            email,
            phone,
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <div className="contact-form">
                                ...
                                <form  method="post" className="row" onSubmit={submitForm}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="condition-check">
                                            ...
                                            <input type='file' accept="image/*,.pdf" name='contact_img' multiple="true" />
                                        </div>
                                    </div>
